...
if not API_KEY:
    st.error("No se encontró la API KEY. Configúrala en las variables de entorno.")
    st.stop()
...
with st.sidebar:
    ...
    personalidad = st.text_area(
        "Personalidad:",
        value="Eres un asistente experto en programación y hardware."
    )
...
if prompt := st.chat_input("Escribe tu duda técnica aquí..."):
    ...
    with st.chat_message("assistant"):
        ...
        try:
            ...
            respuesta = f"❌ Error en el servidor: {e}"
